  ...
  var Icicle = (function (_koto$Base2) {
    function Icicle(selection) {
      ...
      icicle.on('enter', function () {
        ...
        // boxes
        this.selectAll('rect').attr('x', function (d) {
          return _Chart.x(d.x);
        }).attr('y', function (d) {
          return _Chart.y(d.y);
        ...
        if (_Chart._targetData) {
          this.selectAll('path').style('fill', '#555').style('opacity', 0).attr({
            d: (function (_d) {
              function d(_x) {
        ...
        // labels
        this.selectAll('text').text(function (d) {
        ...
        this.duration(duration).ease('linear').delay(function (d) {
          return d.depth * duration;
        }).selectAll('text').style('opacity', function (d) {
